# Generated by Powerlevel10k configuration wizard on 2025-05-26 at 00:39 EDT.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 13396.
# Wizard options: awesome-fontconfig + powerline, large icons, classic, unicode,
# darkest, 12h time, angled separators, blurred heads, flat tails, 2 lines, solid,
# left frame, compact, few icons, concise, instant_prompt=verbose.
